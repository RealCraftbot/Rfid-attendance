...
import { Mail, Lock, ArrowRight, ShieldAlert, GraduationCap, Building } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-50 flex items-center justify-center p-8">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white p-8 rounded-2xl border border-zinc-200 shadow-sm">
          ...
          <p className="text-zinc-500 mb-6">Sign in to access your classroom dashboard</p>
          ...
          <div className="mt-6 text-center text-sm text-zinc-500">
            <p>Are you a parent? <Link href="/login/parent" className="font-bold text-blue-600 hover:underline">Login here</Link></p>
