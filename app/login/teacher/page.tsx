    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex flex-col items-center justify-center p-4 sm:p-6">
      ...
      <div className="w-full max-w-md px-4 sm:px-0">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-zinc-900 mb-1 sm:mb-2">Teacher Login</h1>
          <p className="text-sm sm:text-base text-zinc-500">Access your classroom dashboard</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-zinc-100 p-6 sm:p-8">
          ...
          <div className="mt-6 pt-6 border-t border-zinc-100">
            <div className="flex flex-wrap justify-center gap-3 text-sm text-zinc-600">
              ...
              <Link href="/login/bursar" className="text-blue-600 hover:text-blue-700 font-medium">
                Bursar
              </Link>
        ...
        <div className="mt-6 sm:mt-8 grid grid-cols-3 gap-2 sm:gap-4">
          <div className="text-center p-2 sm:p-4">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-green-100 rounded-xl flex items-center justify-center mx-auto mb-1.5 sm:mb-2">
              <BookOpen size={20} className="text-green-600 sm:w-6 sm:h-6" />
            </div>
            <p className="text-[10px] sm:text-xs text-zinc-600">My Classes</p>
          </div>
          <div className="text-center p-2 sm:p-4">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-amber-100 rounded-xl flex items-center justify-center mx-auto mb-1.5 sm:mb-2">
              <Users size={20} className="text-amber-600 sm:w-6 sm:h-6" />
            </div>
            <p className="text-[10px] sm:text-xs text-zinc-600">Students</p>
          </div>
          <div className="text-center p-2 sm:p-4">
            ...
            <p className="text-[10px] sm:text-xs text-zinc-600">Schedule</p>
          </div>
        </div>
      </div>
    </div>
